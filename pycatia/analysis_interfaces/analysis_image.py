...
class AnalysisImage(AnyObject):
    ...
    def export_data_in_any_user_axis(self, i_folder: Folder, i_file_name: str, i_extension_type: str, i_axis_system: AnyObject, i_product: Product, i_axis_orientation_type: int, i_export_mesh_part_id: bool) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_image.ExportDataInAnyUserAxis(i_folder.com_object, i_file_name, i_extension_type, i_axis_system.com_object, i_product.com_object, i_axis_orientation_type, i_export_mesh_part_id)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def export_data_in_global_axis(self, i_folder: Folder, i_file_name: str, i_extension_type: str, i_axis_orientation_type: int, i_export_mesh_part_id: bool) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_image.ExportDataInGlobalAxis(i_folder.com_object, i_file_name, i_extension_type, i_axis_orientation_type, i_export_mesh_part_id)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def export_data_in_manual_axis(self, i_folder: Folder, i_file_name: str, i_extension_type: str, i_origin: tuple, i_x_direction: tuple, i_y_direction: tuple, i_z_direction: tuple, i_axis_orientation_type: int, i_export_mesh_part_id: bool) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_image.ExportDataInManualAxis(i_folder.com_object, i_file_name, i_extension_type, i_origin, i_x_direction, i_y_direction, i_z_direction, i_axis_orientation_type, i_export_mesh_part_id)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def export_data_in_user_axis(self, i_folder: Folder, i_file_name: str, i_extension_type: str, i_axis_system: AxisSystem, i_product: Product, i_axis_orientation_type: int, i_export_mesh_part_id: bool) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_image.ExportDataInUserAxis(i_folder.com_object, i_file_name, i_extension_type, i_axis_system.com_object, i_product.com_object, i_axis_orientation_type, i_export_mesh_part_id)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_selection(self, i_reference: Reference, i_replace_mode: CATVariant) -> None:
        ...
        :rtype: None
        """
        return self.analysis_image.SetSelection(i_reference.com_object, i_replace_mode.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
