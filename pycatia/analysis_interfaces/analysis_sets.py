...
class AnalysisSets(Collection):
    ...
    def item(self, i_index: CATVariant, i_serach_type: int) -> AnalysisSet:
        """
        .. note::
            :class: toggle
        ...
        :rtype: AnalysisSet
        """
        return AnalysisSet(self.analysis_sets.Item(i_index.com_object, i_serach_type))
    ...
    def remove(self, i_index: CATVariant) -> None:
        ...
        :rtype: None
        """
        return self.analysis_sets.Remove(i_index.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
