...
class AnalysisMeshLocalSpecification(AnyObject):
    ...
    def add_support_from_publication(self, i_name: str, i_product: Product, i_support: Publication) -> None:
        ...
        :rtype: None
        """
        return self.analysis_mesh_local_specification.AddSupportFromPublication(i_name, i_product.com_object, i_support.com_object)
    ...
    def add_support_from_reference(self, i_name: str, i_product: Product, i_support: Reference) -> None:
        ...
        :rtype: None
        """
        return self.analysis_mesh_local_specification.AddSupportFromReference(i_name, i_product.com_object, i_support.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_attribute(self, i_name: str, i_value: CATVariant) -> None:
        ...
        :rtype: None
        """
        return self.analysis_mesh_local_specification.SetAttribute(i_name, i_value.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
