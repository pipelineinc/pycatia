...
class AnalysisImport(AnyObject):
    ...
    def import_disp(self, i_father_case: AnalysisCase, i_full_path: str, i_manager: AnalysisManager, i_axis: AnyObject) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_import.ImportDisp(i_father_case.com_object, i_full_path, i_manager.com_object, i_axis.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def import_force(self, i_father_case: AnalysisCase, i_full_path: str, i_manager: AnalysisManager, i_axis: AnyObject) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_import.ImportForce(i_father_case.com_object, i_full_path, i_manager.com_object, i_axis.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
