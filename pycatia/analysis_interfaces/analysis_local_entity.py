...
class AnalysisLocalEntity(AnyObject):
    ...
    def add_support_from_constraint(self, i_constraint_product: Product, i_constraint: Constraint) -> None:
        ...
        :rtype: None
        """
        return self.analysis_local_entity.AddSupportFromConstraint(i_constraint_product.com_object, i_constraint.com_object)
    ...
    def get_reference(self, i_component: str, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int) -> Reference:
        """
        .. note::
            :class: toggle
        ...
        :rtype: Reference
        """
        return Reference(self.analysis_local_entity.GetReference(i_component, i_label, i_line_index, i_column_index, i_layer_index))

    def get_value(self, i_component: str, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int) -> CATVariant:
        """
        .. note::
            :class: toggle
        ...
        :rtype: CATVariant
        """
        return CATVariant(self.analysis_local_entity.GetValue(i_component, i_label, i_line_index, i_column_index, i_layer_index))

    def set_reference(self, i_component: str, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int, i_value: Reference) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_local_entity.SetReference(i_component, i_label, i_line_index, i_column_index, i_layer_index, i_value.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_value(self, i_component: str, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int, i_value: CATVariant) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_local_entity.SetValue(i_component, i_label, i_line_index, i_column_index, i_layer_index, i_value.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
