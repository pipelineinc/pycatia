...
class AnalysisImages(Collection):
    ...
    def add(self, i_image_name: str, i_hide_existing_images: CATVariant, i_show_mesh: CATVariant, i_duplicate: CATVariant) -> AnalysisImage:
        """
        .. note::
            :class: toggle
        ...
        :rtype: AnalysisImage
        """
        return AnalysisImage(self.analysis_images.Add(i_image_name, i_hide_existing_images.com_object, i_show_mesh.com_object, i_duplicate.com_object))
    ...
    def item(self, i_index: CATVariant) -> AnalysisImage:
        ...
        :rtype: AnalysisImage
        """
        return AnalysisImage(self.analysis_images.Item(i_index.com_object))
