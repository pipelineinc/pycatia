...
class AnalysisMeshPart(AnalysisSet):
    ...
    def set_global_specification(self, i_name: str, i_value: CATVariant) -> None:
        ...
        :rtype: None
        """
        return self.analysis_mesh_part.SetGlobalSpecification(i_name, i_value.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_specification_from_publication(self, i_name: str, i_product: Product, i_support: Publication, i_mode: int) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_mesh_part.SetSpecificationFromPublication(i_name, i_product.com_object, i_support.com_object, i_mode)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_specification_from_reference(self, i_name: str, i_product: Product, i_support: Reference, i_mode: int) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_mesh_part.SetSpecificationFromReference(i_name, i_product.com_object, i_support.com_object, i_mode)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
