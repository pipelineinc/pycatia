...
class BasicComponent(AnyObject):
    ...
    def get_value(self, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int) -> CATVariant:
        ...
        :rtype: CATVariant
        """
        return CATVariant(self.basic_component.GetValue(i_label, i_line_index, i_column_index, i_layer_index))
    ...
    def set_reference(self, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int, i_value: Reference) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.basic_component.SetReference(i_label, i_line_index, i_column_index, i_layer_index, i_value.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
    ...
    def set_value(self, i_label: str, i_line_index: int, i_column_index: int, i_layer_index: int, i_value: CATVariant) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.basic_component.SetValue(i_label, i_line_index, i_column_index, i_layer_index, i_value.com_object)
        # # # # Autogenerated comment: 
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
