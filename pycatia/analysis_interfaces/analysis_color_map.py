...
class AnalysisColorMap(AnyObject):
    ...
    @property
    def discrete_mode(self) -> CATVariant:
        """
        .. note::
            :class: toggle
        ...
        return CATVariant(self.analysis_color_map.DiscreteMode)

    @discrete_mode.setter
    def discrete_mode(self, value: CATVariant):
        """
        :param CATVariant value:
        """
    ...
    @property
    def inverse_mode(self) -> CATVariant:
        """
        .. note::
            :class: toggle
        ...
        return CATVariant(self.analysis_color_map.InverseMode)

    @inverse_mode.setter
    def inverse_mode(self, value: CATVariant):
        """
        :param CATVariant value:
        """
    ...
    @property
    def smooth_mode(self) -> CATVariant:
        """
        .. note::
            :class: toggle
        ...
        return CATVariant(self.analysis_color_map.SmoothMode)

    @smooth_mode.setter
    def smooth_mode(self, value: CATVariant):
        """
        :param CATVariant value:
        """
